...
def add_technical_indicators(df: pd.DataFrame) -> pd.DataFrame:
    ...
    Expects df indexed by datetime or have 'Date' column and columns: Open, High, Low, Close, Volume

    Adds SMA(5,10,20), EMA(12,26), RSI(14), MACD, ATR, returns, log returns.
